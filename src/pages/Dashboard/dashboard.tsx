...
>
  ...
  {/* Logo + Collapse */}
  <div className="flex items-center justify-between p-5 border-b border-blue-600/50">
    {!collapsed && (
      <Link to="/home" className="flex items-center space-x-3">
        <div className="relative">
          <div className="absolute inset-0 bg-blue-400 rounded-xl blur-lg opacity-50"></div>
          <div className="relative w-12 h-12 bg-gradient-to-r from-blue-500 to-blue-600 rounded-xl flex items-center justify-center shadow-lg">
            <Shield className="w-7 h-7 text-white" />
          </div>
        </div>
        <div>
          <h1 className="text-lg font-bold tracking-wide">Radiance Solution</h1>
  ...
  {/* Navigation */}
  <nav className="flex-1 p-4 space-y-2 overflow-y-auto scrollbar-thin scrollbar-thumb-blue-600 scrollbar-track-transparent">
    {menus.map((menu) => {
      ...
      return (
        <div key={menu.id} className="group">
          <button
            ...
            className={`w-full flex items-center justify-between px-4 py-3 rounded-xl text-sm font-medium transition relative overflow-hidden ${
              isExpanded
          ...
          >
            ...
            <div className="relative flex items-center space-x-3">
              <div className="w-10 h-10 flex items-center justify-center bg-blue-900/60 rounded-lg shadow-inner">
                <i
          ...
          {!collapsed && menu.submenulist?.length > 0 && (
            <div
              className={`ml-6 mt-2 space-y-2 border-l border-blue-700/50 pl-4 transition-all duration-500 ease-in-out ${
            ...
            >
              {menu.submenulist.map((sub) => (
                <button
                  ...
                  className="block w-full text-left px-3 py-2 text-sm rounded-lg text-blue-200 hover:bg-blue-700/40 hover:text-white transition"
                >
                  {sub.name}
                </button>
              ))}
  ...
  style={{ marginLeft: collapsed ? "5rem" : "20rem" }}
>
        ...
        <header className="relative bg-gradient-to-r from-white/90 to-blue-50/90 backdrop-blur-xl border-b border-white/20 shadow-xl overflow-hidden">
          ...
          <div className="relative z-10 flex justify-between items-center px-10 py-8">
            <div>
            ...
            <div className="flex items-center space-x-6">
              {/* Notifications */}
              <button className="relative p-3 rounded-xl hover:bg-white/50 transition-all duration-300 group/notification">
                <div className="absolute inset-0 bg-gradient-to-r from-blue-500/10 to-purple-500/10 rounded-xl opacity-0 group-hover/notification:opacity-100 transition-opacity duration-300"></div>
                <Bell className="relative w-6 h-6 text-slate-600 group-hover/notification:text-slate-800 group-hover/notification:scale-110 transition-all duration-300" />
              ...
              {/* User Info Card */}
              <div className="flex items-center space-x-4 px-6 py-3 bg-white/60 backdrop-blur-sm rounded-2xl border border-white/30 shadow-lg hover:shadow-xl transition-all duration-300 group/userinfo">
              ...
              >
                ...
                <LogOut className="relative w-5 h-5 group-hover/logout:rotate-12 transition-transform duration-300" />
